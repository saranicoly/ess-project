...
def create_reservation(
        ...
        return reservations.create_reservation(client_id, accommodation_id, checkin_date, checkout_date)
...
@app.get("/accommodation/{accommodation_id}/image")
async def get_image(accommodation_id: str):
    try:
        image_url = storage.child("accommodation").child(accommodation_id).get_url(None)
        ...
        raise HTTPException(status_code=500, detail="Erro ao recuperar imagem")
